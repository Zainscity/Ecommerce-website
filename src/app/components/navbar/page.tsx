      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
        ...
        <div className="hidden lg:block">
          <div className="w-[70%] sm:w-[247px] h-[28px] flex gap-x-10">
            <span className="xs:visible w-[28px] h-[28px] text-[30px]">
              <Link href="myaccount">
                <CiUser />
              </Link>
            </span>
            <span className="xs:visible w-[20px] h-[28px] text-[30px]">
              <CiSearch />
            </span>
            <span className="xs:visible w-[20px] h-[28px] text-[30px]">
              <Link href="/checkouts">
        ...
        {/* Mobile Menu Button */}
        <div className="md:hidden flex items-center w-8 -mr-[320px] mt-[5px]">
          <button
